...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("rasterize_graphixs", &RasterizeGraphixsCUDA);
  m.def("rasterize_graphixs_backward", &RasterizeGraphixsBackwardCUDA);
  m.def("compute_relocation_graphixs", &ComputeRelocationGraphixsCUDA);
}