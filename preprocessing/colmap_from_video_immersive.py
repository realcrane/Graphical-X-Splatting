...
#
# For original inquiries contact OPPO
...
from utils.preprocessing_utils import write_colmap

from utils.preprocessing_utils import posetow2c_matrcs, rotmat2qvec, qvec2rotmat
from utils.preprocessing_utils import focal2fov, fov2focal
from utils.colmap_utils import * 
from utils.preprocessing_utils import getcolmapsingleimdistort
from utils.preprocessing_utils import extractframes


SCALEDICT = {}


Immersiveseven = ["01_Welder",  "02_Flames", "04_Truck", "05_Horse", "06_Goats", "09_Alexa", "10_Alexa", "11_Alexa", "12_Cave"]
immmersivescaledict = {}
immmersivescaledict["01_Welder"] = 0.36
immmersivescaledict["02_Flames"] = 0.35
immmersivescaledict["04_Truck"] = 0.36
immmersivescaledict["05_Horse"] = 0.36
immmersivescaledict["06_Goats"] = 0.36
...
def softlinkdataset(originalpath: Path, path: Path):
    ...
    for videofolder in videofolderlist:
        ...
        if newlink.exists() or newlink.is_symlink():
            newlink.unlink()
        newlink.symlink_to(videofolder.resolve())
